...
class RemoteSqlReleaseWorkflowTests(unittest.TestCase):
    ...
    def test_release_tag_and_version_base_match_copy10(self) -> None:
        self.assertIn("v0.151.0-remote-sql-copy.10", self.text)
        self.assertIn("VERSION_BASE: 0.151.0-remote-sql-copy.10", self.text)
