...
///
/// Responses namespaces are flattened to the callable name used by the runtime
/// registry. Responses-only and freeform tool kinds are omitted because Chat
/// Completions cannot represent them.
